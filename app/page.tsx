        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
              <div className="inline-block px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-bold mb-4">
                Competitor X-Ray
              </div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Compare ratings, review volume, and response times side-by-side with up to 5 local competitors. Get alerted when their ratings change. Spot their weaknesses before they fix them.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI reads every review and surfaces the patterns you&apos;d miss. Know which staff members patients love — and which ones cost you ratings. &quot;Long wait times&quot; mentioned 7 times this month? You&apos;ll know on day one.
              </p>
            </div>

            {/* AI Fix-It List */}
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
              <div className="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-bold mb-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                Prioritized actions based on what&apos;s actually hurting your ratings. Specific to your reviews and your market — not generic advice. Like having a $200/hr practice consultant for $49/mo.
              </p>
            </div>
          </div>
        </div>
